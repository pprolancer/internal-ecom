...
class CategoryTestCase(TestCase):
    ...
    def test_fail_stringification(self):
        ...
        self.assertEqual(self.category_name_2.__str__(), category_name_2, "USER STRING METHOD NOT WORK")
...
class ProductTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.product_3 = Product.objects.get(pk=3)
    ...
    def test_pass_stringification(self):
        ...
        self.assertEqual(self.product_2.__str__(), product_name_2, "USER STRING METHOD WORK")
    ...
    def test_fail_stringification(self):
        ...
        product_name_3 = self.product_3.product_name
        self.assertEqual(self.product_3.__str__(), product_name_3, "USER STRING METHOD NOT WORK")        